    ...
    return `
        <!DOCTYPE>
            <html style="margin: 0; padding: 0;">
                ...
                <tbody>
                <tr>
                <td style="">안녕하세요.<br><span style="color: #F5BD60;">School Point </span>인증 이메일입니다.
                </td>
                </tr>
                </tbody>
                </table>
                ...
                <tr>
                <td style="padding: 10.0px 0 25.0px 0;font-size: 28.0px;font-weight: bold;color: #F5BD60;"><span>${data}</span>
                </td>
                </tr>
                </tbody>
                </table>
